...
//    }
    ...
    <T extends TagModel> void findAllExistsOneEntry(JpaRepository<T, Long> repositoryMock, Class<T> aModelClass, Service<T> service) {
        //arrange
        T expectedModel = TestModel.generateModel(aModelClass);
        expectedModel.setId(1L);
        List<T> expected = new ArrayList<>();
    ...
    <T extends TagModel> void findAllEmptyTable(JpaRepository<T, Long> repositoryMock, Service<T> service) {
        List<T> emptyCollection = new ArrayList<>();
        when(repositoryMock.findAll()).thenReturn(emptyCollection);
    ...
    <T extends TagModel> void removeExistingEntryReturnsTrue(JpaRepository<T, Long> repositoryMock, Class<T> aModelClass, Service<T> service) {
        T model = TestModel.generateModel(aModelClass);
        model.setId(1L);
//        when(repositoryMock.remove(model.getId())).thenReturn(true);
    ...
    <T extends TagModel> void removeIfNotExistsReturnsFalse(JpaRepository<T, Long> repositoryMock, Class<T> aModelClass, Service<T> service) {
        T model = TestModel.generateModel(aModelClass);
        model.setId(1L);
//        when(repositoryMock.remove(model.getId())).thenReturn(false);
    ...
    <T extends TagModel> void saveCorrectModelSuccessfulValidation(JpaRepository<T, Long> repositoryMock, Class<T> aModelClass, Service<T> service) {
        //arrange
        T expected = TestModel.generateModel(aModelClass);
        expected.setId(1L);
        when(repositoryMock.save(any())).thenReturn(expected);
    ...
    <T extends TagModel> void saveIncorrectModelValidationNotAccepted(JpaRepository<T, Long> repositoryMock, Class<T> aModelClass, Service<T> service)
            throws HomeFinanceServiceException {
        T model = TestModel.generateModel(aModelClass);
        String emptyName = "";
        model.setName(emptyName);
    ...
    <T extends TagModel> void updateCorrectModelSameModelReturned(JpaRepository<T, Long> repositoryMock, Class<T> aModelClass, Service<T> service) {
        //arrange
        T expected = TestModel.generateModel(aModelClass);
        expected.setId(1L);
    ...
    <T extends TagModel> void updateIncorrectModelCausesException(JpaRepository<T, Long> repositoryMock, Class<T> aModelClass, Service<T> service) throws HomeFinanceServiceException {
        T model = TestModel.generateModel(aModelClass);
        String emptyName = "";
        model.setId(1L).setName(emptyName);

...
-- -----------------------------------------------------
-- Table `home_finance`.`tag_tbl`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `home_finance`.`tag_tbl` (
  `id` INT NOT NULL AUTO_INCREMENT,
  `name` VARCHAR(45) NULL,
...
-- -----------------------------------------------------
-- Table `home_finance`.`tag_relation_tbl`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `home_finance`.`tag_relation_tbl` (
  `id` INT NOT NULL AUTO_INCREMENT,
  `tag` INT NOT NULL,
  `transaction` INT NOT NULL,
  PRIMARY KEY (`id`),
  INDEX `relation_tag_fk_idx` (`tag` ASC),
  INDEX `relation_transaction_fk_idx` (`transaction` ASC),
  CONSTRAINT `relation_tag_fk`
    FOREIGN KEY (`tag`)
    REFERENCES `home_finance`.`tag_tbl` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `relation_transaction_fk`
    FOREIGN KEY (`transaction`)
    REFERENCES `home_finance`.`transaction_tbl` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
START TRANSACTION;
USE `home_finance`;
INSERT INTO `home_finance`.`transaction_tbl` (`id`, `amount`, `datetime`, `account`, `category`, `transaction_type`, `name`) VALUES (1, 50000, '2018-02-02', 1, 1, 'INCOME', NULL);
INSERT INTO `home_finance`.`transaction_tbl` (`id`, `amount`, `datetime`, `account`, `category`, `transaction_type`, `name`) VALUES (2, 35000, '2018-02-05', 1, 1, 'INCOME', NULL);
INSERT INTO `home_finance`.`transaction_tbl` (`id`, `amount`, `datetime`, `account`, `category`, `transaction_type`, `name`) VALUES (3, 25000, '2018-04-03', 2, 1, 'INCOME', NULL);
INSERT INTO `home_finance`.`transaction_tbl` (`id`, `amount`, `datetime`, `account`, `category`, `transaction_type`, `name`) VALUES (4, 15000, '2018-04-10', 2, 1, 'INCOME', NULL);
INSERT INTO `home_finance`.`transaction_tbl` (`id`, `amount`, `datetime`, `account`, `category`, `transaction_type`, `name`) VALUES (5, 4200, '2018-02-10', 1, 2, 'EXPENSE', NULL);
INSERT INTO `home_finance`.`transaction_tbl` (`id`, `amount`, `datetime`, `account`, `category`, `transaction_type`, `name`) VALUES (6, 1500, '2018-04-10', 2, 3, 'EXPENSE', NULL);
